 							...
 							상수명n (값들...)	;
 							 ...
 							 ✅ '값들' 을 저장할 변수들 선언한다. 
									...
									...
	 							 	private 자료형이름 변수명n;
 							 ✅ 열거형의 생성자를 만든다. 
 							 ✅ 열거형의 생성자는 '열거형 상수'에 지정한 '값들'을 변수에 세팅하는 역할을 수행한다.  
 							 ✅ 열거형 생성자는 묵시적으로 접근제한자가 'private' 이다. 
 							 
 							 ✅ 열거형의 생성자이 매개변수는 '값들'과 객수가 같고 자료형이 맞아야 한다. 
...
//		}
		...
		/*
		 * //서로 다른 종류의 열거형끼리의 비교는 불가하다. if (mycol == mycnt) {
		...
		//switch문의 case에 지정하는 상수값은 '열거형 이름'을 생략한 '상수이름'만 지정해야 한다. 
		switch (mycnt) {
		//case Count.ONE :System.out.println("ONE 입니다."); 
		...
		for (Season time : Season.values()) {
			...
			+ "-->" + time.getSpan() + ", 평균기온: " + time.getTemp() + "도");
		}
	}
}
